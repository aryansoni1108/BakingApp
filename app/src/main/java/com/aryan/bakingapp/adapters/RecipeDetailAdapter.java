...
package com.aryan.bakingapp.adapters;
...
public class RecipeDetailAdapter extends RecyclerView.Adapter<RecipeDetailAdapter.RecyclerViewHolder> {
    ...
    final private ListItemClickListener listclicklistenernClickListener;
    ...
    public RecipeDetailAdapter(ListItemClickListener listener) {
        listclicklistenernClickListener =listener;
    }
    ...
    class RecyclerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            listclicklistenernClickListener.onListItemClick(lSteps,clickedPosition,recipeName);
        }
